var xrhtml = (function (exports, THREE) {
	'use strict';
	...
	class XRHTML extends THREE__namespace.Group {
	  ...
	  VR(enable){
	    ...
	    XRHTML.parser( this.getRealDOM(), this.getRealOptions(), (object3D) => {
	      ...
	      if( !this.opts.singleside ) this.mesh.material.side = THREE__namespace.DoubleSide;
	  ...
	  monkeyPatchRenderer(){
	    let size = new THREE__namespace.Vector2();
